...
void BusTubInstance::HandleCreateStatement(Transaction *txn, const CreateStatement &stmt, ResultWriter &writer) {
    ...
    if (!stmt.primary_key_.empty()) {
        ...
        // TODO(spring2023): If you want to support composite index key for leaderboard optimization, remove this
        // assertion and create index with different key type that can hold multiple keys based on number of index
        // columns.
        //
