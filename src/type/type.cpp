...
auto Type::IsCoercableFrom(const TypeId type_id) const -> bool {
    switch (type_id_) {
        ...
        case DECIMAL:
            ...
            break;
        case TIMESTAMP: return (type_id == VARCHAR || type_id == TIMESTAMP);
        case VARCHAR:
            switch (type_id) {
                case BOOLEAN:
                case TINYINT:
            ...
            break;
        default: return (type_id == type_id_);
    }  // END SWITCH
}
...
auto Type::GetMinValue(TypeId type_id) -> Value {
    switch (type_id) {
        case BOOLEAN: return {type_id, 0};
        case TINYINT: return {type_id, BUSTUB_INT8_MIN};
        case SMALLINT: return {type_id, BUSTUB_INT16_MIN};
        case INTEGER: return {type_id, BUSTUB_INT32_MIN};
        case BIGINT: return {type_id, BUSTUB_INT64_MIN};
        case DECIMAL: return {type_id, BUSTUB_DECIMAL_MIN};
        case TIMESTAMP: return {type_id, 0};
        case VARCHAR: return {type_id, ""};
        default: break;
    }
...
auto Type::GetMaxValue(TypeId type_id) -> Value {
    switch (type_id) {
        case BOOLEAN: return {type_id, 1};
        case TINYINT: return {type_id, BUSTUB_INT8_MAX};
        case SMALLINT: return {type_id, BUSTUB_INT16_MAX};
        case INTEGER: return {type_id, BUSTUB_INT32_MAX};
        case BIGINT: return {type_id, BUSTUB_INT64_MAX};
        case DECIMAL: return {type_id, BUSTUB_DECIMAL_MAX};
        case TIMESTAMP: return {type_id, BUSTUB_TIMESTAMP_MAX};
        case VARCHAR: return {type_id, nullptr, 0, false};
        default: break;
    }
