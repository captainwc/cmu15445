...
struct fmt::formatter<bustub::OrderByType> : formatter<string_view> {
    ...
    auto format(bustub::OrderByType c, FormatContext &ctx) const {
        string_view name;
        switch (c) {
            case bustub::OrderByType::INVALID: name = "Invalid"; break;
            case bustub::OrderByType::ASC: name = "Ascending"; break;
            case bustub::OrderByType::DESC: name = "Descending"; break;
            case bustub::OrderByType::DEFAULT: name = "Default"; break;
