...
public:
    ...
    virtual auto ToString() const -> std::string {
        switch (type_) {
            case TableReferenceType::INVALID: return "";
...
struct fmt::formatter<bustub::TableReferenceType> : formatter<string_view> {
    ...
    auto format(bustub::TableReferenceType c, FormatContext &ctx) const {
        string_view name;
        switch (c) {
            case bustub::TableReferenceType::INVALID: name = "Invalid"; break;
            case bustub::TableReferenceType::BASE_TABLE: name = "BaseTable"; break;
            case bustub::TableReferenceType::JOIN: name = "Join"; break;
            case bustub::TableReferenceType::CROSS_PRODUCT: name = "CrossProduct"; break;
            case bustub::TableReferenceType::EMPTY: name = "Empty"; break;
            case bustub::TableReferenceType::EXPRESSION_LIST: name = "ExpressionList"; break;
            case bustub::TableReferenceType::SUBQUERY: name = "Subquery"; break;
            case bustub::TableReferenceType::CTE: name = "CTE"; break;
