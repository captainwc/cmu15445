...
struct fmt::formatter<bustub::JoinType> : formatter<string_view> {
    ...
    auto format(bustub::JoinType c, FormatContext &ctx) const {
        string_view name;
        switch (c) {
            case bustub::JoinType::INVALID: name = "Invalid"; break;
            case bustub::JoinType::LEFT: name = "Left"; break;
            case bustub::JoinType::RIGHT: name = "Right"; break;
            case bustub::JoinType::INNER: name = "Inner"; break;
            case bustub::JoinType::OUTER: name = "Outer"; break;
