...
public:
    ...
    static inline auto GetNullValueByType(TypeId type_id) -> Value {
        Value ret_value;
        switch (type_id) {
            case TypeId::BOOLEAN: ret_value = GetBooleanValue(BUSTUB_BOOLEAN_NULL); break;
            case TypeId::TINYINT: ret_value = GetTinyIntValue(BUSTUB_INT8_NULL); break;
            case TypeId::SMALLINT: ret_value = GetSmallIntValue(BUSTUB_INT16_NULL); break;
            case TypeId::INTEGER: ret_value = GetIntegerValue(BUSTUB_INT32_NULL); break;
            case TypeId::BIGINT: ret_value = GetBigIntValue(BUSTUB_INT64_NULL); break;
            case TypeId::DECIMAL: ret_value = GetDecimalValue(BUSTUB_DECIMAL_NULL); break;
            case TypeId::VARCHAR: ret_value = GetVarcharValue(nullptr, false, nullptr); break;
            default: {
    ...
    static inline auto GetZeroValueByType(TypeId type_id) -> Value {
        ...
        switch (type_id) {
            case TypeId::BOOLEAN: return GetBooleanValue(false);
            case TypeId::TINYINT: return GetTinyIntValue(0);
            case TypeId::SMALLINT: return GetSmallIntValue(0);
            case TypeId::INTEGER: return GetIntegerValue(0);
            case TypeId::BIGINT: return GetBigIntValue(0);
            case TypeId::DECIMAL: return GetDecimalValue(static_cast<double>(0));
            case TypeId::VARCHAR: return GetVarcharValue(zero_string);
            default: break;
        }
    ...
    static inline auto CastAsBigInt(const Value &value) -> Value {
        if (Type::GetInstance(TypeId::BIGINT)->IsCoercableFrom(value.GetTypeId())) {
            ...
            switch (value.GetTypeId()) {
                case TypeId::TINYINT: return ValueFactory::GetBigIntValue(static_cast<int64_t>(value.GetAs<int8_t>()));
                case TypeId::SMALLINT:
                    return ValueFactory::GetBigIntValue(static_cast<int64_t>(value.GetAs<int16_t>()));
                case TypeId::INTEGER: return ValueFactory::GetBigIntValue(static_cast<int64_t>(value.GetAs<int32_t>()));
                case TypeId::BIGINT: return ValueFactory::GetBigIntValue(value.GetAs<int64_t>());
                case TypeId::DECIMAL: {
    ...
    static inline auto CastAsInteger(const Value &value) -> Value {
        if (Type::GetInstance(TypeId::INTEGER)->IsCoercableFrom(value.GetTypeId())) {
            ...
            switch (value.GetTypeId()) {
                case TypeId::TINYINT: return ValueFactory::GetIntegerValue(static_cast<int32_t>(value.GetAs<int8_t>()));
                case TypeId::SMALLINT:
                    return ValueFactory::GetIntegerValue(static_cast<int32_t>(value.GetAs<int16_t>()));
                case TypeId::INTEGER: return ValueFactory::GetIntegerValue(value.GetAs<int32_t>());
                case TypeId::BIGINT: {
    ...
    static inline auto CastAsSmallInt(const Value &value) -> Value {
        if (Type::GetInstance(TypeId::SMALLINT)->IsCoercableFrom(value.GetTypeId())) {
            ...
            switch (value.GetTypeId()) {
                ...
                case TypeId::SMALLINT: return ValueFactory::GetSmallIntValue(value.GetAs<int16_t>());
                case TypeId::INTEGER: {
    ...
    static inline auto CastAsTinyInt(const Value &value) -> Value {
        if (Type::GetInstance(TypeId::TINYINT)->IsCoercableFrom(value.GetTypeId())) {
            ...
            switch (value.GetTypeId()) {
                case TypeId::TINYINT: return ValueFactory::GetTinyIntValue(value.GetAs<int8_t>());
                case TypeId::SMALLINT: {
    ...
    static inline auto CastAsDecimal(const Value &value) -> Value {
        if (Type::GetInstance(TypeId::DECIMAL)->IsCoercableFrom(value.GetTypeId())) {
            ...
            switch (value.GetTypeId()) {
                case TypeId::TINYINT: return ValueFactory::GetDecimalValue(static_cast<double>(value.GetAs<int8_t>()));
                case TypeId::SMALLINT:
                    return ValueFactory::GetDecimalValue(static_cast<double>(value.GetAs<int16_t>()));
                case TypeId::INTEGER: return ValueFactory::GetDecimalValue(static_cast<double>(value.GetAs<int32_t>()));
                case TypeId::BIGINT: return ValueFactory::GetDecimalValue(static_cast<double>(value.GetAs<int64_t>()));
                case TypeId::DECIMAL: return ValueFactory::GetDecimalValue(value.GetAs<double>());
                case TypeId::VARCHAR: {
                    std::string str = value.ToString();
                    double      res = 0;
                    try {
    ...
    static inline auto CastAsVarchar(const Value &value) -> Value {
        if (Type::GetInstance(TypeId::VARCHAR)->IsCoercableFrom(value.GetTypeId())) {
            ...
            switch (value.GetTypeId()) {
                ...
                case TypeId::BIGINT:
                case TypeId::DECIMAL:
                case TypeId::VARCHAR: return ValueFactory::GetVarcharValue(value.ToString());
                default: break;
            }
        }
    ...
    static inline auto CastAsTimestamp(const Value &value) -> Value {
        if (Type::GetInstance(TypeId::TIMESTAMP)->IsCoercableFrom(value.GetTypeId())) {
            ...
            switch (value.GetTypeId()) {
                case TypeId::TIMESTAMP: return ValueFactory::GetTimestampValue(value.GetAs<uint64_t>());
                case TypeId::VARCHAR: {
                    std::string str = value.ToString();
                    if (str.length() == 22) {
    ...
    static inline auto CastAsBoolean(const Value &value) -> Value {
        if (Type::GetInstance(TypeId::BOOLEAN)->IsCoercableFrom(value.GetTypeId())) {
            ...
            switch (value.GetTypeId()) {
                case TypeId::BOOLEAN: return ValueFactory::GetBooleanValue(value.GetAs<int8_t>());
                case TypeId::VARCHAR: {
                    std::string str = value.ToString();
