...
public:
     ...
     */
    WindowFunctionPlanNode(SchemaRef output_schema, AbstractPlanNodeRef child,
                           std::vector<uint32_t> window_func_indexes, std::vector<AbstractExpressionRef> columns,
...
struct fmt::formatter<bustub::WindowFunctionType> : formatter<std::string> {
    ...
    auto format(bustub::WindowFunctionType c, FormatContext &ctx) const {
        ...
        switch (c) {
            case WindowFunctionType::CountStarAggregate: name = "count_star"; break;
            case WindowFunctionType::CountAggregate: name = "count"; break;
            case WindowFunctionType::SumAggregate: name = "sum"; break;
            case WindowFunctionType::MinAggregate: name = "min"; break;
            case WindowFunctionType::MaxAggregate: name = "max"; break;
            case WindowFunctionType::Rank: name = "rank"; break;
        }
