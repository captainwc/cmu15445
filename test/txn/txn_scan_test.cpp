...
TEST(TxnScanTest, DISABLED_TupleReconstructTest) {  // NOLINT
    ...
    }
    {
        ...
        auto undo_log_2 =
            UndoLog{false, {true, true, true}, Tuple{{IntNull(), DoubleNull(), BoolNull()}, schema.get()}};
        {
...
TEST(TxnScanTest, DISABLED_CollectUndoLogTest) {  // NOLINT
    ...
    auto undo_link1 = txn1->AppendUndoLog(UndoLog{
        false, {true, true, false}, Tuple{{Int(1), Double(1.0)}, modify_schema.get()}, txn0->GetCommitTs(), {}});
    ...
    auto undo_link2 = txn1->AppendUndoLog(UndoLog{
        false, {true, true, false}, Tuple{{Int(1), Double(1.0)}, modify_schema.get()}, txn0->GetCommitTs(), {}});
    auto undo_link3 = txn2->AppendUndoLog(UndoLog{false,
                                                  {true, true, false},
                                                  Tuple{{Int(2), Double(2.0)}, modify_schema.get()},
                                                  txn1->GetCommitTs(),
                                                  undo_link2});
    ...
    auto undo_link4 = txn3->AppendUndoLog(UndoLog{
        false, {true, true, false}, Tuple{{Int(3), Double(3.0)}, modify_schema.get()}, txn2->GetCommitTs(), {}});
    ...
    auto undo_link5 = txn3->AppendUndoLog(UndoLog{
        false, {true, true, false}, Tuple{{Int(2), Double(2.0)}, modify_schema.get()}, txn1->GetCommitTs(), {}});
    ...
    auto undo_link8 = txn_to_inspect->AppendUndoLog(UndoLog{
        false, {true, true, false}, Tuple{{Int(1), Double(1.0)}, modify_schema.get()}, txn0->GetCommitTs(), {}});
    ...
    auto undo_link9  = txn1->AppendUndoLog(UndoLog{
        false, {true, true, false}, Tuple{{Int(1), Double(1.0)}, modify_schema.get()}, txn0->GetCommitTs(), {}});
    auto undo_link10 = txn4->AppendUndoLog(UndoLog{false,
                                                   {true, true, false},
                                                   Tuple{{Int(4), Double(4.0)}, modify_schema.get()},
                                                   txn3->GetCommitTs(),
                                                   undo_link9});
...

    {
        ...
        auto tuple =
            ReconstructTuple(schema.get(), tuple_res_0.second, tuple_res_0.first, *undo_logs_0_for_txn_to_inspect);
        ASSERT_TRUE(tuple.has_value());
...

    {
        ...
        auto tuple =
            ReconstructTuple(schema.get(), tuple_res_1.second, tuple_res_1.first, *undo_logs_1_for_txn_to_inspect);
        ASSERT_TRUE(tuple.has_value());
    ...
    }
    {
        ...
        auto tuple =
            ReconstructTuple(schema.get(), tuple_res_2.second, tuple_res_2.first, *undo_logs_2_for_txn_to_inspect);
        ASSERT_TRUE(tuple.has_value());
        VerifyTuple(schema.get(), *tuple, {Int(2), Double(2.0), BoolNull()});
    }
    ...
    { ASSERT_FALSE(undo_logs_4_for_txn_to_inspect.has_value()); }
    {
        ...
        auto tuple =
            ReconstructTuple(schema.get(), tuple_res_5.second, tuple_res_5.first, *undo_logs_5_for_txn_to_inspect);
        ASSERT_TRUE(tuple.has_value());
        VerifyTuple(schema.get(), *tuple, {Int(2), Double(2.0), BoolNull()});
    }
    {
        ...
        auto tuple =
            ReconstructTuple(schema.get(), tuple_res_6.second, tuple_res_6.first, *undo_logs_6_for_txn_to_inspect);
        ASSERT_FALSE(tuple.has_value());
    }
    {
        ASSERT_TRUE(undo_logs_7_for_txn_to_inspect.has_value());
        auto tuple =
            ReconstructTuple(schema.get(), tuple_res_7.second, tuple_res_7.first, *undo_logs_7_for_txn_to_inspect);
        ASSERT_TRUE(tuple.has_value());
    ...
    }
    {
        ...
        auto tuple =
            ReconstructTuple(schema.get(), tuple_res_8.second, tuple_res_8.first, *undo_logs_8_for_txn_to_inspect);
        ASSERT_TRUE(tuple.has_value());
        VerifyTuple(schema.get(), *tuple, {Int(100), Double(100.0), BoolNull()});
    }
    {
        ...
        auto tuple =
            ReconstructTuple(schema.get(), tuple_res_9.second, tuple_res_9.first, *undo_logs_9_for_txn_to_inspect);
        ASSERT_TRUE(tuple.has_value());
        VerifyTuple(schema.get(), *tuple, {Int(1), Double(1.0), BoolNull()});
    }
}
...
TEST(TxnScanTest, DISABLED_ScanTest) {  // NOLINT
...

    {
        ...
        prev_log_6 = txn_store_2->AppendUndoLog(
            UndoLog{false, {true, false, false}, Tuple{{Int(7)}, modify_schema.get()}, 1, {}});
...

    {
        ...
        prev_log_2 = txn_store_3->AppendUndoLog(
            UndoLog{true, {false, false, false}, Tuple{{}, empty_schema.get()}, 2, prev_log_3});
