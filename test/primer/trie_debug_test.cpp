...
TEST(TrieDebugger, TestCase) {
    ...
    for (uint32_t i = 0; i < 100; i++) {
        ...
        switch (i) {
            ...
            case 0: ASSERT_EQ(value, 128) << "Random generator not portable, please post on Piazza for help."; break;
            case 1: ASSERT_EQ(value, 16) << "Random generator not portable, please post on Piazza for help."; break;
            case 2: ASSERT_EQ(value, 41) << "Random generator not portable, please post on Piazza for help."; break;
            default: break;
        }
